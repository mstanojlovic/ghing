...
from pypureclient._version import __version__ as VERSION
...
REQUIRES = [
    ...
    'setuptools >= 70.0.0, < 81.0.0; python_version <= "3.10"',
...
setup(
    ...
    download_url=f'https://github.com/PureStorage-OpenConnect/py-pure-client/archive/{VERSION}.tar.gz',
